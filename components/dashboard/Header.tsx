      ...
      <div className="flex mx-auto items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-4 pl-[80px]">
          <div className="relative">
            <div className="flex items-center h-[48px] rounded-[30px] border border-[#3C374E] p-4 gap-3 min-w-[400px]">
              <Search className="h-5 w-5 text-[#FA266D]" />
              <input
                type="text"
                placeholder="Search for anything here..."
                className="bg-transparent text-white placeholder-gray-400 focus:outline-none flex-1"
              />
              <button className="text-[#FA266D] hover:text-pink-400 transition-colors cursor-pointer">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4 pr-0 sm:pr-[80px]">
          {/* Message Icon */}
          <button className="w-8 h-8 sm:w-10 sm:h-10 bg-[#3C374E] rounded-full flex items-center justify-center hover:bg-gray-600 transition-colors">
          ...
          <div className="hidden sm:flex items-center gap-2 rounded-lg px-3 sm:px-4 py-2">
            ...
            {isLoadingBalance ? (
              ...
              <span className="text-white text-[16px] font-medium sm:text-base">
